...
public class qes1 {
	...
	public static void main(String[] args) {
        ...
        driver.findElement(By.xpath("//*[@id=\"first-name\"]")).sendKeys("Dinesh");
        driver.findElement(By.xpath("//*[@id=\"last-name\"]")).sendKeys("Pandy");
        driver.findElement(By.xpath("//*[@id=\"postal-code\"]")).sendKeys("256478");
